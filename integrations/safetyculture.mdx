...
**One Code, Every Option**
Create a Page carrying multiple Destinations. Everyone who scans sees the same set and picks the one they came for — QRtub does not identify the scanner:
- **Start Inspection** → start a new inspection
- **View Report** → the latest report
- **Asset History** → the Mitti asset profile
