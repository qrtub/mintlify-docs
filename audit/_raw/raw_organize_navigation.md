...
The [navigation](/docs/organize/settings-structure#navigation) property in `docs.json` controls the structure and information hierarchy of your documentation.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of pages." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/pages-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=d9531be8cc28553992a6513ff09fc6ed" width="1184" height="320" data-path="images/navigation/pages-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of pages." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/pages-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=ec51691241465e13d49afafcd30748f8" width="1184" height="320" data-path="images/navigation/pages-dark.png" />

In the `navigation` object, `pages` is an array. Each entry must reference the path to a [page file](/docs/organize/pages).
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of groups." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/groups-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=393243b71cd60407c0ea883359592699" width="1184" height="320" data-path="images/navigation/groups-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of groups." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/groups-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=834d116249fcd1484808f1a534ea2892" width="1184" height="320" data-path="images/navigation/groups-dark.png" />
...
Use the `directory` property to automatically render a directory of child pages and groups on group root pages. Set `directory` on any object within the `navigation` tree in `docs.json`. Groups with a `root` page matching or beneath that object display a listing of their pages and groups below their page contents.
...
The `directory` value inherits recursively through the navigation tree. Set it anywhere within the navigation object and all descendant groups inherit the same value. Any descendant can override the inherited value by setting `directory` to a different value.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of a tab navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/tabs-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=aeec785d0771a3a7a87d941e318bf8e7" width="1184" height="320" data-path="images/navigation/tabs-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of a tab navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/tabs-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=20637c7abbe07ee7b2c41c4df26d2ffd" width="1184" height="320" data-path="images/navigation/tabs-dark.png" />

In the `navigation` object, `tabs` is an array. Each entry is an object that requires a `tab` field and can contain other navigation fields, such as groups, pages, icons, or links to external pages.
...
In the `navigation` object, `menu` is an array. Each entry is an object that requires an `item` field and can contain other navigation fields, such as groups, pages, icons, or links to external pages.

A menu item can hold pages, an external link via `href`, or any navigation division (`groups`, `tabs`, `anchors`, `dropdowns`, `products`, `languages`, or `versions`). Use a division inside a menu item when you want that column to render the same kind of nested navigation that the division provides at the top level.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of an anchor navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/anchors-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=e66255f62fc5d17ca135f21f84ed9325" width="1184" height="320" data-path="images/navigation/anchors-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of an anchor navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/anchors-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=734e33b5fd52071d6f4019b273f2a0e8" width="1184" height="320" data-path="images/navigation/anchors-dark.png" />

In the `navigation` object, `anchors` is an array. Each entry is an object that requires an `anchor` field and can contain other navigation fields, such as groups, pages, icons, or links to external pages.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of a product switcher." src="https://mintcdn.com/mintlify/uTIQZECUoznwRp7Y/images/navigation/product-switcher-light.png?fit=max&auto=format&n=uTIQZECUoznwRp7Y&q=85&s=ab051b15c6e533eb2d723fed8f400704" width="2368" height="640" data-path="images/navigation/product-switcher-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of a product switcher." src="https://mintcdn.com/mintlify/uTIQZECUoznwRp7Y/images/navigation/product-switcher-dark.png?fit=max&auto=format&n=uTIQZECUoznwRp7Y&q=85&s=4827f6913945eeadb2c54362ee0f748d" width="2368" height="640" data-path="images/navigation/product-switcher-dark.png" />
...
In the `navigation` object, `products` is an array. Each entry is an object that requires a `product` field and can contain other navigation fields, such as groups, pages, a [menu](#menus), icons, or links to external pages.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of a dropdown navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/dropdowns-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=f04faa13e4a15c6866b8ceee98362018" width="1184" height="320" data-path="images/navigation/dropdowns-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of a dropdown navigation." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/dropdowns-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=4ee16248cae08fee00fe98952b599041" width="1184" height="320" data-path="images/navigation/dropdowns-dark.png" />

In the `navigation` object, `dropdowns` is an array. Each entry is an object that requires a `dropdown` field and can contain other navigation fields, such as groups, pages, icons, or links to external pages.
...
For more information about referencing OpenAPI endpoints in your docs, see the [OpenAPI setup](/docs/api-playground/openapi-setup).
...
Generate SDK reference pages from the build artifacts of your documentation tools. Add an `sdk` property to a tab with the artifact `format` (`typedoc`, `docfx`, `javadoc`, `sphinx`, or `phpdoc`) and a `source` path or HTTPS URL. You can also add an optional `directory` for the URL prefix of generated pages.
...
For more information about generating artifacts and configuring sources, see the [SDK reference setup](/docs/api-playground/sdk-reference-setup).
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of a version switcher." src="https://mintcdn.com/mintlify/f7fo9pnTEtzBD70_/images/navigation/versions-light.png?fit=max&auto=format&n=f7fo9pnTEtzBD70_&q=85&s=85e9cca71a814be044a285028cf9a2a1" width="1184" height="320" data-path="images/navigation/versions-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of a version switcher." src="https://mintcdn.com/mintlify/f7fo9pnTEtzBD70_/images/navigation/versions-dark.png?fit=max&auto=format&n=f7fo9pnTEtzBD70_&q=85&s=fdb637aea218b4035afdaca14dae7d38" width="1184" height="320" data-path="images/navigation/versions-dark.png" />

In the `navigation` object, `versions` is an array. Each entry is an object that requires a `version` field and can contain any other navigation fields.
...
<img className="block pointer-events-none dark:hidden" alt="Decorative graphic of a language switcher." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/languages-light.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=e451ef6550588674e26e264ce2cbe399" width="1184" height="320" data-path="images/navigation/languages-light.png" />

<img className="pointer-events-none hidden dark:block" alt="Decorative graphic of a language switcher." src="https://mintcdn.com/mintlify/Y6rP0BmbzgwHuEoU/images/navigation/languages-dark.png?fit=max&auto=format&n=Y6rP0BmbzgwHuEoU&q=85&s=99a90032d57cfefe2b46fb0d191391c7" width="1184" height="320" data-path="images/navigation/languages-dark.png" />

In the `navigation` object, `languages` is an array. Each entry is an object that requires a `language` field and can contain any other navigation fields, including language-specific banner, footer, and navbar configurations.
...
For automated translations, [set up an automation](/docs/automations) to run the agent on a schedule or in response to repository pushes.

### Route visitors to their preferred language

If you publish in multiple languages, you can redirect visitors from the root of your site to the language that matches their browser's `Accept-Language` header.

1. Navigate to the [Add-ons](https://app.mintlify.com/settings/deployment/addons) page in your dashboard.
2. Enable **Auto-route to preferred language**.

If a visitor selects a language with the language switcher, Mintlify remembers their choice and stops auto-routing them. If no published language matches the visitor's browser preferences, Mintlify serves your default language.
...
Mixing incompatible child types at the same level fails schema validation. Run [`mint validate`](/docs/cli/commands#mint-validate) locally before publishing to catch these errors.
