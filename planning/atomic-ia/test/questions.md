...
3. Is the way new links get created (random vs numbered) something I set once per Tub, or do I choose it every time I add an Item?
4. If I delete a whole Tub, do the physical QR codes already stuck on my equipment stop working?
...
11. What's the difference between a "core field" and a "custom field" on my Tub?
...
18. Is Direct Mode vs Page Mode a whole-Tub setting, or can one Item be different from the rest?
...
32. What's the "Default Destination" setting on a Tub, and how is it different from setting a Destination on one specific Item?
33. If I export a Tub backup, does that include all my Items, or just the settings?
34. What's the difference between "Merge" and "Replace" when importing a Tub backup?
35. Can I use a backup file to spin up a brand-new Tub, or does it only restore into the Tub I exported it from?
...
45. What counts toward my plan's limits — is it the number of Tubs, Links, Items, or team seats?
