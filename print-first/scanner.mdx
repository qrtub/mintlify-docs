...
When a code resolves to nothing, you get "That code isn't linked yet" and the option to adopt it — see [Adopting an Unknown Code From the Scanner](/print-first/claim-on-scan).
...
- [Adopting an Unknown Code From the Scanner](/print-first/claim-on-scan) — the "Create & open" action for a code QRtub doesn't recognize
