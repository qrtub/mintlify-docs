...
stored CSV and per-code installation status. It simply loses the "made from this Collection"
association.
...
3. **Check whether codes are installed.** They will keep resolving, but each released Link needs
