...
![A CNC machine cutting a sheet of anodised aluminium asset plates, each carrying a QR code, a large asset number and a readable link. The visible plates run in sequence: BOU027, BOU028, BOU029.](/images/print-first-plates.jpg)

Above: a run of anodised plates being cut. The numbers were allocated before any of the
equipment they will be fixed to was recorded, because the sheet has to be machined as one job.
