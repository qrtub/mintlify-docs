---
title: "Key Concepts"
description: "The three-entity model, Link modes, Tubs, and the print-before-link workflow"
---
...
**Key point:** Most people think generating a QR code pattern is all there is. But QRtub recognises that the QR code gets printed or displayed on something physical—and that physical material has real costs, durability characteristics, and lifecycle needs.
...
3. **Automatic personalisation** - Each QR code intelligently routes based on its Item's data
...
- **Page templates** - Design how Pages look for this category
- **Organised management** - Keep equipment separate from products, facilities separate from tools
...
3. But you don't have all your Item details finalised yet
...
A: No. Links can exist without Items (useful for simple redirects). But connecting Links to Items unlocks Pages, URL Templates, and organised management.
