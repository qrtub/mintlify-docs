...
Most people think generating a QR code is all there is—just creating the digital pattern. But QRtub recognises that QR codes get displayed on physical materials: stickers, signs, plaques, billboards, real estate signs, printed ads, NFC chips.

This physical media is what costs money and needs lifecycle management.

## Understanding the Three Entities

QRtub recognises three distinct things in physical QR deployments:
...
Common physical Media types organisations use:
