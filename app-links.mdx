...
Alternatively, combine with [Device Detection](/device-detection) to route iOS users to the App Store and Android users to Google Play.
...
| Wrong browser on iOS (app links blocked) | [Device Detection routing](/device-detection) |
| Different platforms need different app stores | [Device Detection routing](/device-detection) |
...
- [Device Detection](/device-detection) — route users based on device, OS, and browser
- [Conditional Visibility](/conditional-visibility) — show Destinations to specific audiences
- [Pages Overview](/pages-overview) — setting up multi-Destination Pages
