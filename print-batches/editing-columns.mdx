...
the supplier comes back asking for a serial number you left out. Saving rebuilds the stored CSV
...
- **Link Fields** — **Full URL**, **Short URL** and **Active**. Full URL is the column a supplier
  normally needs.
...
of what the supplier actually received. Silently rewriting it would leave you unable to tell what
was produced. If a run genuinely needs different columns, revert the batch to Draft first (see
[Batch Status: Draft to Installed](/print-batches/batch-status)) — Printing can step back, Installed
cannot.
