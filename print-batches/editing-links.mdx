...
Once a batch reaches Printing, Printed or Installed, its link list is frozen:
...
To change a Printing or Printed batch, revert it to Draft first. Installed cannot be reverted at
all — see [Batch Status: Draft to Installed](/print-batches/batch-status).
