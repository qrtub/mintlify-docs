...
- [Preparing Your Print Job](/preparing-print-job) — the quiet zone and minimum size a printed code needs, and how the filenames pair each image with its CSV row
