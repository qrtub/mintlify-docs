...
description: "The five-item orientation checklist for handing a QR code batch to a print shop — production method, spec, data file, code images, matching, and proof"
---
