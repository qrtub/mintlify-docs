...
Open a Collection, select the Items you want, and choose **Print list** from the menu. Pick the
...
Back in the Collection, you can filter Items by the batch they were printed in — useful when a run
